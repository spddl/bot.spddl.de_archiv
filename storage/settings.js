var settings = {
  ...
  botNick: ['bot'],
  password: 'oauth:',
  admins: ['spddl_bot', 'spddl'],
  discordemail: 'email@provider.com',
  discordpassword: '',
  localchannels: ['#spddl', '#spddl_bot'], // toLowerCase
  localbotchannels: ['#spddl', '#spddl_bot'], // ,'#botttich'
  channels: ['#spddl_gaming', '#xall3', '#xatutv', '#jbreelocher', '#gobbtv', '#freddy2712', '#tahsinofficial', '#stv_nash', '#n1k96', '#know1111ng', '#ladydeaths', '#mikemikeybultez', '#navidkapio', '#matthias_mase_meyer', '#collycs', '#rahyy', '#spddl', '#kirby_tv', '#toni_yayo', '#chrisjcsgo', '#voovpingu', '#trotakis'],
