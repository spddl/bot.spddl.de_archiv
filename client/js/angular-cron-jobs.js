...
angular.module("cronselection.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("cronselection.html",
    "<div class=\"cron-wrap col s12\">\n" +
    "<div class=\"row\">\n" +
    "<div class=\"col s12\">\n" +
    "    <span>Jede(n): </span>\n" +
    "    <div class=\"cron-select-wrap input-field inline\">\n" +
    "        <select class=\"cron-select\" ng-model=\"myFrequency.base\" ng-options=\"item.value as item.label for item in frequency\"></select>\n" +
    "    </div>\n" +
    "    <div class=\"select-options input-field inline\">\n" +
    "        <span ng-show=\"myFrequency.base == 4\">on </span>\n" +
    "        <div ng-show=\"myFrequency.base == 4\" class=\"cron-select-wrap input-field inline\">\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base >= 5\">am </span>\n" +
    "        <div ng-show=\"myFrequency.base >= 5\" class=\"cron-select-wrap input-field inline\">\n" +
    "            <!-- If Multiple is Enabled -->\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base == 6\">vom </span>\n" +
    "        <!-- If Multiple is Enabled -->\n" +
    "        <div ng-show=\"myFrequency.base == 6\" class=\"cron-select-wrap input-field inline\">\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base >= 2\">um </span>\n" +
    "        <!-- If Multiple is Enabled -->\n" +
    "        <div ng-show=\"myFrequency.base >= 3\" class=\"cron-select-wrap input-field inline\">\n" +
    ...
    "        <!-- If Multiple is Enabled -->\n" +
    "        <div ng-show=\"myFrequency.base >= 2\" class=\"cron-select-wrap input-field inline\">\n" +
...
.factory('cronService', ['baseFrequency', function(baseFrequency) {
    ...
    service.fromQuartzCron = function(value, allowMultiple) {
        ...
        // console.log('cron[5]: '+cron[5]);

        if (cron[5] !== "*" && cron[5] !== "?") {
        // if (cron[5] && cron[5] !== "*" && cron[5] !== "?") {
            //preparing to handle multiple days of the week
            if (allowMultiple) {
